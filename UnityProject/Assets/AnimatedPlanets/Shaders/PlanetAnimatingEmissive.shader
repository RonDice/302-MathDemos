Shader "Space/PlanetAnimatingEmissive" 
{
    Properties 
    {
    ...
    SubShader 
    {
        ...
        void surf (Input IN, inout SurfaceOutput o) 
		{
			...
			half4 color = tex2D (_RampTex, float2(d,0.5));
			o.Albedo = color.rgb + _RimColor.rgb * pow (rim, _RimPower);
			o.Emission = color.a*color.rgb;
		}
		ENDCG
	}
    Fallback "Diffuse"
